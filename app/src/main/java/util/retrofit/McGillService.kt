...
interface McGillService {
    ...
    fun search(
        @Query("term_in") term: Term,
        @Query("sel_subj") subject: String,
        @Query("sel_crse") courseNumber: String,
        @Query("sel_title") title: String,
        @Query("sel_from_cred") minCredits: Int,
        @Query("sel_to_cred") maxCredits: Int,
        @Query("begin_hh") startHour: Int,
        @Query("begin_mi") startMinute: Int,
        @Query("begin_ap") startAM: String,
        @Query("end_hh") endHour: Int,
        @Query("end_mi") endMinute: Int,
        @Query("end_ap") endAM: String,
