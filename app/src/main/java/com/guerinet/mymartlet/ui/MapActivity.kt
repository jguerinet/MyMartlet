...
class MapActivity : DrawerActivity(), OnMapReadyCallback, GoogleMap.OnMarkerClickListener {
    ...
    private fun getDirections() {
        ...
        val intent = Intent(Intent.ACTION_VIEW, Uri.parse("http://maps.google.com/maps?f=d &daddr="
    ...
    override fun onMapReady(googleMap: GoogleMap) {
        ...
        SQLite.select()
                ...
                .queryListResultCallback { _, tResult ->
                    ...
                    tResult.mapNotNullTo(places) {
                        // Create a marker for this
                        val marker = map?.addMarker(MarkerOptions()
                                .position(it.coordinates)
                                .draggable(false)
                                .visible(true)) ?: return@mapNotNullTo null
    ...
    override fun onMarkerClick(marker: Marker?): Boolean {
        ...
        place?.second?.setIcon(BitmapDescriptorFactory.defaultMarker(
        ...
        favorite.setText(if (place?.first?.isFavorite == true)
