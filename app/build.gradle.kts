...
dependencies {
    ...
    implementation(Deps.Android.Suitcase.DATE_ANDROID)
    ...
    implementation(Deps.Android.Suitcase.SETTINGS)
    implementation(Deps.Android.Suitcase.ROOM)
    implementation(Deps.Android.Suitcase.UI)
    implementation(Deps.Android.Suitcase.UTIL)
    ...
    implementation(Deps.SPLITTIES_ACTIVITIES)
}
