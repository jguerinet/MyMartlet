    ...
    fun validStatementList() {
        ...
        val expectedStatements = listOf(
            ...
            Statement(
                ...
                dueDate = LocalDate.of(2018, 10, 31),
                amount = 0.0
            ),
            Statement(
            ...
            Statement(
                date = LocalDate.of(2018, 1, 10),
                dueDate = LocalDate.of(2018, 1, 31),
                amount = 0.0
            ),
            Statement(
            ...
            Statement(
                date = LocalDate.of(2017, 6, 5),
                dueDate = LocalDate.of(2017, 6, 29),
                amount = -29.6
            ),
            Statement(
            ...
            Statement(
                ...
                dueDate = LocalDate.of(2017, 1, 31),
                amount = 0.0
            ),
            Statement(
